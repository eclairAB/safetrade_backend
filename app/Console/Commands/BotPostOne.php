...
class BotPostOne extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'botpost:one';
     ...
     * @var string
     */
    protected $description = 'Will make bot 1 post a trade';
    ...
    {
      $bot_wallets = UserCurrency::where('user_id', 1)->first();
