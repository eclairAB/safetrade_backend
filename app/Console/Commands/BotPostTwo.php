...
class BotPostTwo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'botpost:two';
     ...
     * @var string
     */
    protected $description = 'Will make bot 2 post a trade';
    ...
    {
      $bot_wallets = UserCurrency::where('user_id', 2)->first();
