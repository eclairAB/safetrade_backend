...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::post(
        'update/user/basic/{id}',
        'Auth\UserController@updateProfileBasic'
    );
    Route::post(
        'update/user/account/{id}',
        'Auth\UserController@updateProfileAccount'
    );
    ...
    Route::post(
        'getUser/trade/{id}/{trader_id}',
        'UserWalletController@getUserTrade'
    ...
    Route::post(
        'monitor/user/transaction',
        'UserWalletController@monitorUserTransaction'
    );
    Route::post(
        'avoid/user/transfer/{id}',
        'UserWalletController@avoidUserTransfer'
    );
